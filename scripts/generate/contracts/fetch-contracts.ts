...
export const node = {
  ...
  feeds: [
    ...
    'check:literals', 'check:members', 'check:structure',
    'check:affordances', 'check:behaviour', 'check:composition', 'check:fonts', 'check:environment',
    'check:contrast', 'check:control', 'check:target', 'check:parity', 'check:motion',
  ],
};
